define(['text!pages/constructionorder/constructionorderDetail.html', 'css!pages/constructionorder/constructionorderDetail', 'pages/payment/paymentmeta', 'uuigrid'], function(template) {
