define(['text!pages/dispayment/dispayment.html', 'css!pages/dispayment/dispayment', 'pages/payment/paymentmeta', 'uuigrid'], function(template) {
    ...
    offset: '60'
				...
				renderTypeAjax : function(obj) {
					...
					var text = obj.value;
					var html = "<a style='text-decoration: underline;' class='c_green' href='#/dispayment/dispaymentDetail?id=" + id + "'>" + text || ' ' + "</a>";
