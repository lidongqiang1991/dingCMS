define(['text!pages/transferpay/transferpayDetail.html', 'css!pages/transferpay/transferpayDetail', 'pages/transferpay/transferpaymeta', 'uuigrid'], function(template) {
	...
	var init = function(element) {
		...
		var viewModel = {
			...
			objdata : new u.DataTable(paymentmeta),
			// 筛选 数据
			searchdatanew : new u.DataTable(paymentmeta),
			typeList : [{
				name : "全部类型",
				value : "-1"
			}, {
